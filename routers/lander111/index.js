...
const orderModel3 = require("../../models/orderModel111");
const orderModel3Abd = require("../../models/orderModel111-abd");
...
router.post("/create-order", async (req, res) => {
  ...
  try {
    ...
    const existingOrder = await orderModel3.findOne({ orderId });
      if (existingOrder) {
...
router.patch("/delivery-status/:id", async (req, res) => {
  try {
    ...
    const order = await orderModel3.findByIdAndUpdate(
      id,
